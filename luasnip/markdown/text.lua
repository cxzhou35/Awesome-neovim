...
return {
  ...
  s(
    { trig = "sb", snippetType = "autosnippet", priority = 2000 },
    fmta("**<>**", {
      d(1, get_visual),
    })
  ),
  s(
    { trig = "si", snippetType = "autosnippet", priority = 2000 },
    fmta("*<>*", {
      d(1, get_visual),
    })
  ),
  s(
    { trig = "sh", snippetType = "autosnippet", priority = 2000 },
    fmta("==<>==", {
      d(1, get_visual),
    })
  ),
  s(
    { trig = "sc", snippetType = "autosnippet", priority = 2000 },
    fmta("`<>`", {
      d(1, get_visual),
    })
  ),
  s(
    { trig = "sw", snippetType = "autosnippet", priority = 2000 },
    fmta("[[<>]]", {
      d(1, get_visual),
    })
  ),
