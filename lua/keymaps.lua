...
-- Picgo
keymap.set("n", "<leader>uc", "<cmd>lua require'nvim-picgo'.upload_clipboard()<cr>")
keymap.set("n", "<leader>ui", "<cmd>lua require'nvim-picgo'.upload_imagefile()<cr>")
...
keymap.set("n", "<space>e", vim.diagnostic.open_float, { silent = true, noremap = true })

-- Highlight string
vim.api.nvim_set_keymap("v", "zh", ":<c-u>HSHighlight 1<CR>", { noremap = true, silent = true })

vim.api.nvim_set_keymap("v", "zn", ":<c-u>HSRmHighlight<CR>", { noremap = true, silent = true })
